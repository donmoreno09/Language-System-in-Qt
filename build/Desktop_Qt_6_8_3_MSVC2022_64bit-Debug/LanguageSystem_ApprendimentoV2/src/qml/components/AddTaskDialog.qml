        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    background: Rectangle {
                        color: parent.activeFocus ? Qt.rgba(0.39, 0.4, 0.94, 0.1) : backgroundColor
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    ComboBox {
                        ...
                        background: Rectangle {
                            color: parent.hovered ? Qt.rgba(0.39, 0.4, 0.94, 0.1) : backgroundColor
                            border.color: parent.activeFocus ? primaryColor : "#e2e8f0"
                            border.width: parent.activeFocus ? 2 : 1
                            radius: 12
                        ...
                        delegate: ItemDelegate {
                            ...
                            background: Rectangle {
                                color: highlighted ? Qt.rgba(0.39, 0.4, 0.94, 0.2) : "transparent"
                                radius: 8
                            }
                            ...
                            ColumnLayout {
                                ...
                                GridLayout {
                                    ...
                                    Button {
                                        ...
                                        background: Rectangle {
                                            radius: 8
                                            color: parent.hovered ? Qt.rgba(0.39, 0.4, 0.94, 0.2) : backgroundColor
                                            border.color: Qt.rgba(0.39, 0.4, 0.94, 0.4)
                                            border.width: 1
                                        }
    ...
    footer: Rectangle {
        ...
        RowLayout {
            ...
            Button {
                ...
                background: Rectangle {
                    radius: 12
                    color: parent.hovered ? Qt.rgba(0.39, 0.28, 0.29, 0.2) : "transparent"
                    border.color: Qt.rgba(0.39, 0.28, 0.29, 0.6)
                    border.width: 1
            ...
            Button {
                ...
                background: Rectangle {
                    radius: 12
                    color: parent.enabled ? "transparent" : Qt.rgba(0.39, 0.28, 0.29, 0.4)

                    gradient: parent.enabled ? gradientEnabled : null

                    property Gradient gradientEnabled: Gradient {
                        GradientStop { position: 0.0; color: primaryColor }
                        GradientStop { position: 1.0; color: secondaryColor }
                    }
                    ...
                    DropShadow {
                        ...
                        radius: 12
                        samples: 25
                        color: parent.parent.enabled ? Qt.rgba(0.39, 0.4, 0.94, 0.4) : "transparent"
                    }
